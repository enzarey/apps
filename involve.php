...
<html>
<head>
<title>APPS: Register or Sign-in</title>
<meta charset="UTF-8">
...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="home" >
  ...
  <center>
  <a href="reg.php"><span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">REGISTER</span></a><br><br>
   <a href="sign-in.php"><span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">SIGN-IN</span></a>
   </center> 
   </div>
   </div>
