...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="home" >
  ...
  <center>
   <a href="diy.php"><span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">DIYs!</span></a><br><br>
  <a href="volunteer.php"><span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">VOLUNTEER</span></a><br><br>
   <a href="wysiwyg.php"><span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">WRITE AN ARTICLE</span></a><br><br>
   <a href="awareness.php"><span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">SPREAD AWARENESS!</span></a><br>
   </center> 
   </div>
   </div>
